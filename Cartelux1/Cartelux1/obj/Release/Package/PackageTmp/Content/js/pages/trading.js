                ...
                success: function (response) {
                    ...
                    if (response.d.length > 0) {
                        ...
                        for (var i = 0; i < response.d.length; i++) {
                            ...
                            // Botón OPC - Opciones
                            var btnOrdenesPendientes_id = "btnOrdenesPendientes_" + formID;
                            console.log("goToOPC values");
                            console.log(formID);
                            console.log(nombre);
                            console.log(telefono);
                            var goToOPC = "<a id=\"" + btnOrdenesPendientes_id + "\" role='button' href='#' class='btn btn-info btn-xs fa fa-asterisk fa-2x' onclick='return showActionMenu_OPC(\"" + formID + "\", \"" + telefono + "\", \"" + nombre + "\", \"" + btnOrdenesPendientes_id + "\")'></a>";
                            // ----------------------
